          ...
          <div className="bg-uc-warm-mid rounded-[28px] overflow-hidden p-8 md:p-14">
            <div className="grid md:grid-cols-5 gap-8 items-center">
              <div className="md:col-span-2">
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-uc-black/[0.04] max-w-[280px]">
                  <div className="flex items-center gap-2.5 mb-4">
                    <div className="w-8 h-8 bg-uc-coral rounded-full flex items-center justify-center">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {["bg-amber-100", "bg-rose-100", "bg-sky-100", "bg-emerald-100", "bg-violet-100", "bg-orange-100"].map(
                      (bg, i) => (
              ...
              <div className="md:col-span-3 space-y-3">
                {[
                  { icon: MessageCircle, color: "bg-green-500", name: "Laura", text: "¡Nuevo pedido!", time: "Hace 2 min", amount: "$85.000" },
                  { icon: ShoppingBag, color: "bg-uc-coral", name: "Karina", text: "¡Nuevo pedido!", time: "Hace 5 min", amount: "$120.000" },
                  { icon: Heart, color: "bg-pink-500", name: "Juan", text: "¡Nuevo pedido!", time: "Hace 8 min", amount: "$45.000" },
                ].map((item, i) => (
                  <div
                    key={i}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[13px] font-semibold text-uc-black">
                          {item.text} <span className="font-normal text-uc-gray">de {item.name}</span>
                        </p>
                        <p className="text-[11px] text-uc-gray-light">{item.time}</p>
                      </div>
                    </div>
